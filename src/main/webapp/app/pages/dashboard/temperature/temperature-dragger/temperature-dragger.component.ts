...
export class TemperatureDraggerComponent implements AfterViewInit, OnChanges {
    ...
    @Input()
    fillColors: string | string[] = '#2ec6ff';
    @Input()
    disableArcColor = '#999999';
    @Input()
    bottomAngle = 90;
    @Input()
    arcThickness = 18; // CSS pixels
    @Input()
    thumbRadius = 16; // CSS pixels
    @Input()
    thumbBorder = 3;
    @Input()
    maxLeap = 0.4;
    ...
    @Input()
    min = 0; // min output value
    @Input()
    max = 100; // max output value
    @Input()
    step = 0.1;
