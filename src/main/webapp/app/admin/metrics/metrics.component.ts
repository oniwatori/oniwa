...
import { NgxMetricsMonitoringModalComponent } from './metrics-modal.component';
...
export class NgxMetricsMonitoringComponent implements OnInit {
    ...
    refreshThreadDumpData() {
        this.metricsService.threadDump().subscribe(data => {
            const modalRef = this.modalService.open(NgxMetricsMonitoringModalComponent, { size: 'lg' });
